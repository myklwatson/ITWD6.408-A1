    ...
    let ui = `
      <div class="flip-card position-relative" id="hosting-card">
        ...
        <div class="flip-card-back position-absolute w-100 h-100 p-3 rounded overflow-y-auto text-start">
          ...
          <p class="fs-6 lh-base">
            We are also using <strong>Vercel</strong> to publish this project. It connects directly to my GitHub repository and automatically redeploys the live site whenever I push a new commit. It requires no manual server configuration - well suited to a static multi-page HTML/CSS/JS project. Since the site has no server-side rendering  (all backend functionality is handled externally through Supabase), Vercel's static hosting is a good fit.
          </p>  
